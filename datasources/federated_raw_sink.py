...
class FederatedRawSink(KafkaMLSink):
    ...
    def __init__(self, boostrap_servers, topic, deployment_id,
        ...
        validation_rate=0, test_rate=0, control_topic='FEDERATED_DATA_CONTROL_TOPIC', group_id='sink', unsupervised_topic=None, federated_string_id=None, label_weights=None, streaming_data_chunks=None):
        
        input_format='RAW'
        super().__init__(boostrap_servers, topic, deployment_id, input_format, description,
            dataset_restrictions, validation_rate, test_rate, control_topic, group_id, unsupervised_topic, federated_string_id, label_weights, streaming_data_chunks)
